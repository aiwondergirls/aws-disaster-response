...
# Get News from Newspapers and Twitter
    ...
    st.markdown('- **EMDAT Dataset:** disaster and emergencies database with number of affected populations and damage')
    st.markdown('- **World Bank Indicators Dataset:** socioeconomic factors' )    
    st.markdown('- **USGS dataset:** earthquake information')
    st.markdown('- **Natural Earth Dataset:** countries geolocation information')        
